...
RaspberryPi 4 sends a start signal (pulse low for >18 ms)
RaspberryPi 4 waits 20-40 us for DHT11 response

DHT11 response is a low signal for 80us
then a high for 80 us
data bit start to follow

low signal for 50us
followed by high signal (70us for a 1, or 26us to 28us for a 0)
